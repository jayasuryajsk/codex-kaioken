...
The package version matches this repository (for example `0.1.7`) and automatically fetches the corresponding artifact (`codex-kaioken-<platform>.tar.gz` or `.zip`) that CI attached to the release.
