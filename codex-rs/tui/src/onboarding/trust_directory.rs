...
impl WidgetRef for &TrustDirectoryWidget {
    fn render_ref(&self, area: Rect, buf: &mut Buffer) {
        ...
        column.push(Line::from(vec![
            "> ".into(),
            "You are running Codex Kaioken in ".bold(),
            self.cwd.to_string_lossy().to_string().into(),
        ]));
        column.push("");

        let guidance = if self.is_git_repo {
            "Since this folder is version controlled, you may wish to allow Codex Kaioken to work in this folder without asking for approval."
        } else {
        ...
        if self.is_git_repo {
            options.push((
                "Yes, allow Codex Kaioken to work in this folder without asking for approval",
            ...
            options.push((
                "Allow Codex Kaioken to work in this folder without asking for approval",
                TrustDirectorySelection::Trust,
            ));
            options.push((
