...
/// Load skills for a given codex_home and working directory.
/// This is a convenience function for loading skills without a full Config.
pub fn load_skills_for_cwd(codex_home: &Path, cwd: &Path) -> SkillLoadOutcome {
    load_skills_from_roots(skill_roots_for_cwd(codex_home, cwd))
}
